...
```shell
git clone https://github.com/multipristr/workshift-system.git && docker image build --tag workshift-system workshift-system/ && docker run -p 8080:8080 workshift-system
```
